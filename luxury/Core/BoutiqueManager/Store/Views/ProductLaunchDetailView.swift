...
struct ProductLaunchDetailView: View {
    ...
    var body: some View {
        ...
        .alert("Cancel Product Launch?", isPresented: $showCancelAlert) {
            ...
            Text("This will notify all invited clients and remove the product launch event from the boutique calendar.")
        }
    }
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            Grid(alignment: .leading, horizontalSpacing: 24, verticalSpacing: 16) {
                GridRow {
                    ...
                    detailLabel(icon: "location.fill", title: "VENUE", value: event.venue ?? "Main Showroom")
                }
                
                GridRow {
                    detailLabel(icon: "sparkles", title: "FEATURED PRODUCT", value: event.featuredCollection ?? "Exquisite Product Collection")
                    detailLabel(icon: "person.badge.shield.checkmark.fill", title: "COORDINATOR", value: event.hostAssociate ?? "Sarah Connor")
                }
            }
        }
        .padding(24)
            ...
            VStack(spacing: 10) {
                ForEach(guests) { guest in
                    HStack(spacing: 16) {
                        ...
                        // Dropdown selector status badge
                        Menu {
