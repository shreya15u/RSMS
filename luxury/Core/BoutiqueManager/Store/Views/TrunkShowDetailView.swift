...
struct TrunkShowDetailView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                ScrollView(showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        // Event Banner Card (Case 1 details)
                        eventBannerCard
                        
                        // RSVP Stats / Analytics Card
                        rsvpAnalyticsCard
                        
                        // Guest List
                        guestListSection
                        
                        // Case 3 Cancellation Section
                        cancellationCard
                    }
        ...
        .alert("Cancel Trunk Show?", isPresented: $showCancelAlert) {
            ...
            Text("This will notify all invited clients about the cancellation and remove the trunk show from the boutique calendar.")
        }
    }
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            Grid(alignment: .leading, horizontalSpacing: 24, verticalSpacing: 16) {
                GridRow {
                    ...
                    detailLabel(icon: "location.fill", title: "LOCATION", value: event.venue ?? "Garden Terrace")
                }
                
                GridRow {
                    detailLabel(icon: "sparkles", title: "COLLECTION", value: event.featuredCollection ?? "Cruise Collection")
                    detailLabel(icon: "person.badge.shield.checkmark.fill", title: "ASSIGNED STAFF", value: event.hostAssociate ?? "Sarah Connor")
                }
            }
        }
        .padding(24)
